...
export const ImageDialog = ({data, onClose}) => {
	...
	return (
		<div className="fixed inset-0 flex items-center justify-center">
			...
			<div className="z-10 bg-white w-11/12 xl:w-9/12 rounded-md mx-auto overflow-auto" style={{maxHeight: "calc(100vh - 100px)"}}>
				...
				<div className="p-5 flex flex-col lg:flex-row gap-10">
					<div className="w-full lg:w-8/12 xl:w-9/12">
						<Image src={data.largeImageURL} alt="" placeholder="blur" blurDataURL={data.blurredDataUrl} width={data.webformatWidth} height={data.webformatHeight} className="w-full rounded-md object-contain" />
					</div>
